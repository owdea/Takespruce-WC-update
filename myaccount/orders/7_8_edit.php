...
<?php else : ?>
	...
	<?php wc_print_notice( esc_html__( 'No order has been made yet.', 'woocommerce' ) . ' <a class="woocommerce-Button button' . esc_attr( $wp_button_class ) . '" href="' . esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'homepage' ) ) ) . '">' . esc_html__( 'Browse products', 'woocommerce' ) . '</a>', 'success' ); // phpcs:ignore WooCommerce.Commenting.CommentHooks.MissingHookComment ?>
